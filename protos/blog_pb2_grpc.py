...
class BlogStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RPCSubscribe = channel.unary_unary(
                ...
                response_deserializer=protos_dot_blog__pb2.Response.FromString,
                _registered_method=True)
        self.RPCUnsubscribe = channel.unary_unary(
                '/blog.Blog/RPCUnsubscribe',
                request_serializer=protos_dot_blog__pb2.Request.SerializeToString,
                response_deserializer=protos_dot_blog__pb2.Response.FromString,
                _registered_method=True)
        self.RPCGetSubscriptions = channel.unary_unary(
                '/blog.Blog/RPCGetSubscriptions',
                request_serializer=protos_dot_blog__pb2.Request.SerializeToString,
                response_deserializer=protos_dot_blog__pb2.Response.FromString,
                _registered_method=True)
        self.RPCGetSubscribers = channel.unary_unary(
                '/blog.Blog/RPCGetSubscribers',
                request_serializer=protos_dot_blog__pb2.Request.SerializeToString,
                response_deserializer=protos_dot_blog__pb2.Response.FromString,
                _registered_method=True)
        self.RPCGetUserFollowers = channel.unary_unary(
                '/blog.Blog/RPCGetUserFollowers',
                request_serializer=protos_dot_blog__pb2.Request.SerializeToString,
                response_deserializer=protos_dot_blog__pb2.Response.FromString,
                _registered_method=True)
...
class BlogServicer(object):
    ...
    def RPCGetSubscribers(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_BlogServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RPCUnsubscribe': grpc.unary_unary_rpc_method_handler(
                    servicer.RPCUnsubscribe,
                    request_deserializer=protos_dot_blog__pb2.Request.FromString,
                    response_serializer=protos_dot_blog__pb2.Response.SerializeToString,
            ),
            'RPCGetSubscriptions': grpc.unary_unary_rpc_method_handler(
                    servicer.RPCGetSubscriptions,
                    request_deserializer=protos_dot_blog__pb2.Request.FromString,
                    response_serializer=protos_dot_blog__pb2.Response.SerializeToString,
            ),
            'RPCGetSubscribers': grpc.unary_unary_rpc_method_handler(
                    servicer.RPCGetSubscribers,
                    request_deserializer=protos_dot_blog__pb2.Request.FromString,
                    response_serializer=protos_dot_blog__pb2.Response.SerializeToString,
            ),
            'RPCGetUserFollowers': grpc.unary_unary_rpc_method_handler(
                    servicer.RPCGetUserFollowers,
                    request_deserializer=protos_dot_blog__pb2.Request.FromString,
                    response_serializer=protos_dot_blog__pb2.Response.SerializeToString,
            ),
...
class Blog(object):
    ...
    @staticmethod
    def RPCGetSubscriptions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def RPCGetUserFollowers(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
